...
```
docker swarm init --advertise-addr 192.168.99.100:2377  - на мастер ноде

docker swarm join --token <ВАШ ТОКЕН ИЗ ПРЕДЫДУЩЕГО ШАГА> 192.168.99.100:2377 - на воркер нодах
